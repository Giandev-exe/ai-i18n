...
describe('JsonFormatter', () => {
  ...
  "farewell": "Goodbye"
      ...
      const units = [createUnit('greeting', 'Hello'), createUnit('farewell', 'Goodbye')];
  ...
  "button": {
    ...
    "cancel": "Cancel"
      ...
      const units = [createUnit('button.save', 'Save'), createUnit('button.cancel', 'Cancel')];
  ...
  "c": "C"
      ...
      const units = [createUnit('a', 'A'), createUnit('b', 'B'), createUnit('c', 'C')];
