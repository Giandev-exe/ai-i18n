 ...
 */
export declare function formatTranslations(originalContent: string, updatedUnits: TranslationUnit[], extractResult: ExtractResult, options?: FormatOptions): FormatResult;
/**
 ...
 */
export declare function createTranslationFile(filePath: string, units: TranslationUnit[], format: FormatInfo['format'], sourceLanguage: string, targetLanguage: string, options?: FormatOptions): void;
/**
